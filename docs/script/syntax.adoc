...
Plain functions may be overloaded, but mechanic is somewhat limited.
See <<Type classes>> for more flexible construct for overloading.
...
Plain variables are also functions and may be also overloaded:
