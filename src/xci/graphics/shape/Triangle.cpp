                            ...
                            FramebufferPixels outline_thickness)
{
    ...
    const auto d1 = xci::core::dist_point_to_line(v1, v2, v3);
    const auto d2 = xci::core::dist_point_to_line(v2, v3, v1);
    const auto d3 = xci::core::dist_point_to_line(v3, v1, v2);
    const float b1 = (d1 / outline_thickness).value;
    const float b2 = (d2 / outline_thickness).value;
    const float b3 = (d3 / outline_thickness).value;
