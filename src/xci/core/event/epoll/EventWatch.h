// epoll/EventWatch.h created on 2019-03-29 as part of xcikit project
// https://github.com/rbrich/xcikit
//
// Copyright 2019 Radek Brich
// Licensed under the Apache License, Version 2.0 (see LICENSE file)

#ifndef XCI_CORE_EPOLL_EVENTWATCH_H
#define XCI_CORE_EPOLL_EVENTWATCH_H
...
/// `EventWatch` implementation for epoll(7) using eventfd(2)
